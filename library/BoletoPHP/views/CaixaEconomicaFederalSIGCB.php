  ...
  <body text="#000000" bgColor="#ffffff" topMargin="0" rightMargin="0" >
      ...
      <tr>
        <td valign="top" class="cp">
          <div align="left">
            ...
            <br />
            <span class="ld2">
            &nbsp;&nbsp;&nbsp;&nbsp;Linha Digit�vel: &nbsp;<?php echo $linha_digitavel; ?>
            <br />
    ...
    <table cellspacing="0" cellpadding="0" border="0">
      <tbody>
        <tr>
          ...
          <td class="ct" valign="top" width="368" height="13">Benefici�rio</td>
          <td class="ct" valign="top" width="7" height="13"><img height="13" src="../imagens/1.png" width="1" border="0"></td>
          <td class="ct" valign="top" width="136" height="13">
            CPF/CNPJ
          </td>
          <td class="ct" valign="top" width="7" height="13"><img height="13" src="../imagens/1.png" width="1" border="0"></td>
          <td class="ct" valign="top" width="134" height="13">Ag�ncia / C�digo do Benefici�rio</td>
        </tr>
        <tr>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
      <tbody>
        <tr>
          <td class="ct" valign="top" width="7" height="13"><img height="13" src="../imagens/1.png" width="1" border="0"></td>
          <td class="ct" valign="top" width="490" height="13">Endere�o do Benefici�rio</td>
          <td class="ct" valign="top" width="7" height="13"><img height="13" src="../imagens/1.png" width="1" border="0"></td>
    ...
    <table cellspacing=0 cellpadding=0 border=0 height="200">
      <tbody >
        <tr>
          ...
          <td class=ct  width=564 ><strong>Instru��es (Texto de Responsabilidade do Benefici�rio):</strong></td>
          <td class=ct  width=7 height=12></td>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
      <tbody>
        <tr>
          ...
          <td class="ct" valign="top" width="7" height="13"><img height="13" src="../imagens/1.png" width="1" border="0"></td>
          <td class="ct" valign="top" width="102" height="13">Esp�cie</td>
          <td class="ct" valign="top" width="7" height="13"><img height="13" src="../imagens/1.png" width="1" border="0"></td>
          ...
          <tr>
            <td width="400" align="center" style="font: normal 10px Arial;">
              <strong class="campo" align="center">
               ...
               0800 726 0101 (informa��es, reclama��es, sugest�es e elogios)
            </td>
            <td width="266" align="center" style="font: normal 10px Arial;">
              Autentica��o Mec�nica - <strong>Recibo do Pagador</strong>
            </td>
          </tr>
          <tr>
            <td width="400" align="center" style="font: normal 10px Arial;" >
              <strong class="campo" align="center" >
                Para pessoas com defici�ncia auditiva ou de fala:
              </strong>
               0800 726 2492
            </td>
    ...
    <table cellspacing=0 cellpadding=0 border=0>
      <tbody>
        <tr>
          <td class=ct valign=top width=7 height=13><img height=13 src="../imagens/1.png" width=1 border=0></td>
          <td class=ct valign=top width=472 height=13>Benefici�rio: </td>
          <td class=ct valign=top width=7 height=13><img height=13 src="../imagens/1.png" width=1 border=0></td>
    ...
    <table cellspacing=0 cellpadding=0 border=0>
      <tbody>
        <tr>
          ...
          <td class=ct valign=top width=63 height=13>Esp�cie Moeda</td>
          <td class=ct valign=top height=13 width=7>
            <img height=13 src="../imagens/1.png" width=1 border=0>
          </td>
        ...
        <tr>
          ...
          <td class=ct  width=250 >
            <div align=right>Autentica��o
              mec�nica - <b class=cp>Ficha de Compensa��o</b>
            </div>
          </td>
        </tr>
        <tr>
